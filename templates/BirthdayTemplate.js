/**
 * Generates a fully formatted Birthday Discount Email HTML.
 * Can be used in Node.js (for email sending) or in browser (for preview).
 */

export function BirthdayTemplate({ user, discountCode, validityDate }) {
  ...
  <head>
      ...
      <title>Happy Birthday from Impression Gallery!</title>
  </head>
                      ...
                      <tr>
                          <td align="left" style="padding: 35px 40px 20px 40px; font-family: Arial, sans-serif; font-size: 16px; line-height: 24px; color: ${colorText};">
                              ...
                              <p style="color: #4B5563; text-align: center;">
                                  We are honored to celebrate another year with you. Happy Birthday from the entire Impression Gallery team!
                              </p>
